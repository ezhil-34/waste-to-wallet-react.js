...
export default function Signup(){
    ...
    return(
         <div className="flex flex-col items-center  min-h-screen justify-center ">
                <div className="w-full max-w-6xl h-[600px] bg-white rounded-3xl shadow-2xl border border-r-8 border-r-teal-500 border-teal-500 border-gray-200 overflow-hidden flex">
                    ...
                    <div className="w-2/5 bg-teal-500 flex flex-col flex items-center justify-center ">
                        ...
                        <button onClick={() => navigate("/Login") }
                            className=" bg-teal-500 border border-white text-white mt-2 px-16 py-3 shadow-md text-lg rounded-full">Sign in</button>

                    </div>

                    <div className="w-3/5 bg-white text-center flex flex-col flex items-center justify-center">
                        <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500 font-bold text-5xl">Create Account</h1>
                        <h2 className="text-teal-500 font-bold text-3xl mt-2" >Enter your details</h2>
                    ...
                    <form className="w-3/4 mt-8" onSubmit={handleSubmit}>
                        ...
                        <button 
                            type="submit"
                            className="bg-teal-500 border border-white text-white mt-8 px-16 py-3 shadow-md text-lg rounded-full"
                        >
                            Sign Up
                        </button>
